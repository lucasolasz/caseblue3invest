  ...
  return (
    <Swiper spaceBetween={50} slidesPerView={3}>
      ...
      >
        ...
        <p className="py-5">
          Você pode investir diretamente na Bolsa de Valores e com o suporte da
          melhor mesa de renda variável do Brasil.
        </p>
      </SwiperSlide>
      <SwiperSlide
        key={2}
      ...
      >
        ...
        <p className="py-5">
          Exposição a moedas estrangeiras sem burocracia e com apoio de um time
          de especialistas.
        </p>
      </SwiperSlide>
      <SwiperSlide
      ...
      >
        ...
        <p className="py-5">
          Invista no setor imobiliário por meio dos fundos mais competitivos do
          momento.
        </p>
      </SwiperSlide>
      ...
      >
        ...
        <p className="py-5">
          Invista em operações estruturadas mesclando o melhor dos dois mundos:
          renda variável e renda fixa em um só tipo de investimento.
        </p>
      </SwiperSlide>
      ...
      >
        ...
        <p className="py-5">
          Diversifique o seu patrimônio e garanta as melhores ações da Bolsa na
          sua carteira com um fundo de índice.
        </p>
      </SwiperSlide>
    </Swiper>
  );
